    ...
    try:
        ...
        for opt, arg in arguments:
            if opt in ('-h', "--help"):
                ...
                file_exists = exists("C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\StartUp\\CRYPTON.exe")
                if not file_exists:
                    # get current path of file
                    src_path = f'{os.getcwd()}\\GUI\\CRYPTON.exe'
                    dest_path = "C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\StartUp\\CRYPTON.exe"
                    # copy source to destination
                    shutil.copy(src_path, dest_path)
                    # re-check if file exists, then print to screen results
                    file_exists = exists("C:\\ProgramData\\Microsoft\\Windows\\Start "
                                         "Menu\\Programs\\StartUp\\CRYPTON.exe")
                    if file_exists:
                ...
                file_exists = exists("C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\StartUp\\CRYPTON.exe")
                if file_exists:
                    os.remove("C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\StartUp\\CRYPTON.exe")
                    file_exists = exists("C:\\ProgramData\\Microsoft\\Windows\\Start "
                                         "Menu\\Programs\\StartUp\\CRYPTON.exe")
                    if not file_exists:
